...
class GvrBuildProcessor : IPreprocessBuild, IPostprocessBuild {
  private const string VR_SETTINGS_NOT_ENABLED_ERROR_MESSAGE_FORMAT =
    "To use the Google VR SDK on {0}, 'PlayerHandler Settings > Virtual Reality Supported' setting must be checked.\n" +
    "Please fix this setting and rebuild your app.";
  private const string IOS_MISSING_GVR_SDK_ERROR_MESSAGE =
    "To use the Google VR SDK on iOS, 'PlayerHandler Settings > Virtual Reality SDKs' must include 'Cardboard'.\n" +
    "Please fix this setting and rebuild your app.";
  private const string ANDROID_MISSING_GVR_SDK_ERROR_MESSAGE =
    "To use the Google VR SDK on Android, 'PlayerHandler Settings > Virtual Reality SDKs' must include 'Daydream' or 'Cardboard'.\n" +
    "Please fix this setting and rebuild your app.";
  ...
  public void OnPreprocessBuild (BuildTarget target, string path)
  {
    ...
    // 'PlayerHandler Settings > Virtual Reality Supported' must be enabled.
  ...
  // 'PlayerHandler Settings > Virtual Reality Supported' enabled?
  private bool IsVRSupportEnabled() {
    return PlayerSettings.virtualRealitySupported;
  }

  // 'PlayerHandler Settings > Virtual Reality SDKs' includes any VR SDK other than 'None'?
