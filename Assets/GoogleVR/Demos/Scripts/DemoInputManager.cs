...
namespace GoogleVR.Demos {
  ...
  public class DemoInputManager : MonoBehaviour {
    ...
    private const string VR_SUPPORT_NOT_CHECKED =
      "Please make sure 'PlayerHandler Settings > Virtual Reality Supported' is checked\n";
    private const string EMPTY_VR_SDK_WARNING_MESSAGE =
      "Please add 'Daydream' or 'Cardboard' under 'PlayerHandler Settings > Virtual Reality SDKs'\n";
    ...
    void Start() {
      ...
      // First loaded device in PlayerHandler Settings.
    ...
    private void UpdateEmulatedPlatformIfPlayerSettingsChanged() {
      ...
      // PlayerHandler Settings > VR SDK list may have changed at runtime. The emulated platform
